...
function lineChart(){
    ...
    Promise.all(promises).then(function(allData){
        ...
        var country = d3.select("#country-list").property("value");
        update(confirmed, svgConfirmed, xConfirmed, yConfirmed, xAxisGroupConfirmed, yAxisGroupConfirmed, country);
        update(deaths, svgDeaths, xDeaths, yDeaths, xAxisGroupDeaths, yAxisGroupDeaths, country);
        update(recovered, svgRecovery, xRecovered, yRecovered, xAxisGroupRecovered, yAxisGroupRecovered, country);
    ...
    function update(data, svg, x, y ,xAxisGroup, yAxisGroup, country){
        // console.log(data);
        // Define transition 
        ...
        var yDomain = [0, d3.max(data, function(d){return +d[country];})]

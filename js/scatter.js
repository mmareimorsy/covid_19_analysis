...
function scatterPlot(){
    ...
    function update(confirmed, deaths, recovered, continentsMap, dateInput){
        ...
        var circles = svg.selectAll("circle").data(fConfirmed);
        ...
        .on("mouseover", function(d,i){
            div.transition().duration(transitionPer).style("opacity", 0.9);
            div.html(
                "<strong>Country:</strong> <span style='color:yellow'>" + confirmed[i].country + "</span><br>" + 
                "<strong>Continent:</strong> <span style='color:yellow'>" + continentsMap[i].continent + "</span><br>" + 
                "<strong>Confirmed Cases:</strong> <span style='color:yellow'>" + d3.format(",.2r")(fConfirmed[i]) + "</span><br>" +
                "<strong>Total Deaths:</strong> <span style='color:yellow'>" + d3.format(",.2r")(fDeaths[i]) + "</span><br>" +
                "<strong>Recovered Cases:</strong> <span style='color:yellow'>" + d3.format(",.2r")(fRecovered[i]) + "</span><br>" + 
